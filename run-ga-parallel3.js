...
//    let candle_values = [3, 5, 10, 15, 17, 20, 30, 60];
    let properites = {
...
//        "candleSize": candle_values[randomExt.integer(8, 0)],
        "candleSize": 5,
        "normalemashort": randomExt.integer(45, 10),
        "normalemalong": randomExt.integer(30, 3),
        "normalthresholdsdown": randomExt.integer(-1, -200) / 100,
        "normalthresholdsup": randomExt.integer(200, 1) / 100,
        "normalRSIthresholdsinterval": randomExt.integer(40, 5),
        "normalRSIthresholdslow": randomExt.integer(65, 20),
        "normalRSIthresholdshigh": randomExt.integer(100, 50),
        "upemashort": randomExt.integer(50, 10),
        "upemalong": randomExt.integer(30, 3),
        "upthresholdsdown": randomExt.integer(-1, -200) / 100,
        "upthresholdsup": randomExt.integer(200, 1) / 100,
        "upRSIthresholdsinterval": randomExt.integer(40, 5),
        "upRSIthresholdslow": randomExt.integer(65, 20),
        "upRSIthresholdshigh": randomExt.integer(100, 50),
        "downemashort": randomExt.integer(50, 10),
        "downemalong": randomExt.integer(30, 3),
        "downthresholdsdown": randomExt.integer(-1, -200) / 100,
        "downthresholdsup": randomExt.integer(200, 1) / 100,
        "downRSIthresholdsinterval": randomExt.integer(40, 5),
        "downRSIthresholdslow": randomExt.integer(65, 20),
        "downRSIthresholdshigh": randomExt.integer(100, 50),
    };
...
function fitness_api(tests_series, callback) {
    ...
    async.mapLimit(tests_series, number_of_parallel_queries, function (data, callback) {
            ...
            //                "backtest": {
            //                    "daterange": {
            //                        "from": "2017-07-23T22:31:00Z",
            //                        "to": "2017-11-04T00:20:00Z"
            //                    }
            //                },
            //                "performanceAnalyzer": {
            //                    "riskFreeReturn": 2,
            ...
            let outconfig = {
                "gekkoConfig": {
                    ...
                    "custom": {
                        "normal": {
                            "DEMAthresholds": {
                                "short": data.normalemashort,
                                "long": data.normalemalong,
                                "thresholds": {
                                    "down": data.normalthresholdsdown,
                                    "up": data.normalthresholdsup
                                },
                            },
                            "RSIthresholds": {
                                "interval": data.normalRSIthresholdsinterval,
                                "thresholds": {
                                    "low": data.normalRSIthresholdslow,
                                    "high": data.normalRSIthresholdshigh,
                                    "persistence": 0
                                }
                            }
                        },
                        "up": {
                            "DEMAthresholds": {
                                "short": data.upemashort,
                                "long": data.upemalong,
                                "thresholds": {
                                    "down": data.upthresholdsdown,
                                    "up": data.upthresholdsup
                                },
                            },
                            "RSIthresholds": {
                                "interval": data.upRSIthresholdsinterval,
                                "thresholds": {
                                    "low": data.upRSIthresholdslow,
                                    "high": data.upRSIthresholdshigh,
                                    "persistence": 0
                                }
                            }
                        },
                        "down": {
                            "DEMAthresholds": {
                                "short": data.downemashort,
                                "long": data.downemalong,
                                "thresholds": {
                                    "down": data.downthresholdsdown,
                                    "up": data.downthresholdsup
                                },
                            },
                            "RSIthresholds": {
                                "interval": data.downRSIthresholdsinterval,
                                "thresholds": {
                                    "low": data.downRSIthresholdslow,
                                    "high": data.downRSIthresholdshigh,
                                    "persistence": 0
                                }
                            }
                        }
